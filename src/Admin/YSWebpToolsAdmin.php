    ...
    public function enqueue_assets( string $hook ): void {
        ...
        wp_localize_script( 'ys-webp-tools-admin', 'ysWebpToolsAdmin', [
            ...
            'i18n'     => [
                ...
                'error'                 => __( '操作失敗，請重試', 'ys-webp-tools' ),
                'regenConfirmCleanup'   => __( '確定要「清理停用尺寸」嗎？將刪除既有圖片中已停用尺寸的舊縮圖，無法復原。', 'ys-webp-tools' ),
                'regenConfirmRebuild'   => __( '確定要「完整重建全部縮圖」嗎？將刪除所有縮圖後依設定重建，無法復原。', 'ys-webp-tools' ),
                ...
                'contentReplaceConfirm' => __( '確定要執行替換嗎？將修改文章內容（post_content），無法復原，建議先備份資料庫。', 'ys-webp-tools' ),
                'contentProg'           => __( '掃描中 %1$d / %2$d…', 'ys-webp-tools' ),
                'contentScanDone'       => __( '掃描完成：%1$d 篇文章、共 %2$d 個失效圖片網址可修復。', 'ys-webp-tools' ),
                'contentReplaceDone'    => __( '替換完成：已更新 %1$d 篇文章、%2$d 個圖片網址。', 'ys-webp-tools' ),
                'contentEmpty'          => __( '沒有需要修復的文章。', 'ys-webp-tools' ),
                'contentSamplesTitle'   => __( '預覽（最多 5 筆）：', 'ys-webp-tools' ),
            ],
        ] );
    }
